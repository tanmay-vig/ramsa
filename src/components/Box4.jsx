            ...
            <div>
                ...
                <div className="style4">
                    <div style={{ marginRight: "100px" }}>
                        <Box4b
                            name1="Prof. Bhagwati Prasad Chamola,"
                            position1="Professor"
                        ></Box4b>
                ...
                <Box4b name1= "Dr. Shashankaditya Upadhyay," position1="Assistant Professor"></Box4b> */}
                    ...
                    <div style={{ marginRight: "100px" }}>
                        <Box4b
                            name1="Prof. Amit Srivastava,"
                            position1="Professor"
                        ></Box4b>
                    </div>
                    <div>
                        <Box4b
                            name1="Dr.  Lakhveer Kaur,"
                    ...
                    <div style={{ marginRight: "100px" }}>
                        <Box4b
                            name1="Dr. Kamlesh Kumar Shukla,"
                            position1="Assistant Professor"
                        ></Box4b>
                    </div>
                    <div>
                        <Box4b
                            name1="Dr. Neha Ahlawat,"
                            position1="Assistant Professor"
                        ></Box4b>
                    </div>
                </div>{" "}
                ...
                <div style={{ marginRight: "100px" }}>
                    <Box4b
                        name1="Dr.  Neha Singhal,"
                        position1="Assistant Professor"
                    ></Box4b>
                </div>
                <div>
                    <Box4b
                        name1="Dr. Mohd. Sarfaraz,"
                        position1="Assistant Professor"
                    ></Box4b>
                </div>
            </div>{" "}
