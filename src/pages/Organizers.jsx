...
function Organizers() {
  return (
    <div className='mainstyle'>
      ...
      <br /><br />
      <Box2 post = "CONFERENCE CHAIR" name1= "Prof. Alka Tripathi," position1 = "Head, Department of Mathematics"/>
      ...
      <div className="style2">
        ...
        <div className='style'>
          ...
          <Box3 post = "HOSPITALITY CHAIR" name1= "Dr.  Himanshu Agarwal" position1 = "Assistant Professor"/>
          
          
          
        </div>
        <div className='style'>
          <Box3 post = "PUBLICITY & BROADCAST CHAIR" name1= "Dr. Amita Bhagat" position1 = "Assistant Professor"/>
          <div className='style-special'></div>
          <Box3 post = "REGISTRATION CHAIR" name1= "Dr. Richa Sharma" position1 = "Assistant Professor" className= "style-special"/>
        </div>
      </div>
      {/* <div className='style'>
