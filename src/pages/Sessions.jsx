...
export default function Sessions() {
    return (
        <>
            ...
            <div>
                <div>
                    The RAMSA 2024 team invites proposals for Special Sessions
                    within the aims and scope of the conference, following these
                    guidelines:
                    <ul>
                        <li>
                            Each session should consist of <b>
                              at least 5 paper</b> presentations.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            eligible for a registration fee waiver for one of
                            their papers for RAMSA 2024 if their session has at
                            least 5 paper registrations.
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div>
                ...
                Please send your proposals to ramsa.conference2024@gmail.com.
            </div>
            ...
            <div>
                <ul>
                    ...
                    <li>
                        ...
                        organizers must send the final accepted abstracts/papers
                        to ramsa.conference2024@gmail.com, no later than the
                        deadlines defined by the conference.
                    </li>
                    <li>
